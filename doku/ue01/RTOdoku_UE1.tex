...
\\
\\
Da kein Task unter einer ms dauert kann der Overhead der Messung vernachlässigt werden, da er unter einem Promille liegt.
...
Mithilfe des Systicks wird ein Zeitdelta berechnet, um festzustellen, wie viel Zeit seit der letzten Ausführung der jeweiligen Tasks vergangen ist.
